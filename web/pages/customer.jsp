        ...
        <tbody>
          ...
          <tr>
              ...
              <td>
                  ...
                  <!-- Delete Button -->
                  <a href="<%=request.getContextPath()%>/DeleteCustomerServlet?account_number=<%=rs.getString("account_number")%>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this customer?')">Delete</a>
              </td>
          </tr>
          ...
          <div class="modal fade" id="editCustomerModal<%=rs.getString("account_number")%>" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog">
              <form action="<%=request.getContextPath()%>/EditCustomerServlet" method="post">
